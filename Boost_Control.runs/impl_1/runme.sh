...
HD_PWD='C:/Users/Chris/Desktop/Research/Boost_Control/Boost_Control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log preset_LFSR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source preset_LFSR.tcl -notrace
