...
HD_PWD='C:/Users/Chris/Desktop/Research/Boost_Control/Boost_Control.runs/step_counter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log step_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source step_counter.tcl
